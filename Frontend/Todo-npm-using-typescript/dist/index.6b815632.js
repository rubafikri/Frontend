...
function addItem(todoItem) {
    ...
    deleteButton.addEventListener("click", (event)=>{
        (0, _axiosDefault.default).delete(`https://localhost:7253/api/todo?id=${todoItem.id}`, {
            method: "DELETE"
        }).then(()=>location.reload()).catch((e)=>console.log(e));
...
(0, _axiosDefault.default).get(`${BASEURL}/Getall`).then((response)=>{
...
function CreateEditForm(todoItem) {
    ...
    button.addEventListener("click", (e)=>{
        e.preventDefault();
        (0, _axiosDefault.default).put(`https://localhost:7253/api/todo/${todoItem.id}`, {
            task: input.value,
...
function CreateAddForm() {
    ...
    button.addEventListener("click", function(event) {
        event.preventDefault();
        (0, _axiosDefault.default).post(`https://localhost:7253/addpost`, {
            task: input.value,
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4ibyE","kuM8f"], "kuM8f", "parcelRequire94c2")
